...
_dynamic_imports: typing.Dict[str, str] = {
    "StreamEntitiesResponse": ".stream_entities_response",
    "StreamEntitiesResponse_Entity": ".stream_entities_response",
    "StreamEntitiesResponse_Heartbeat": ".stream_entities_response",
}
