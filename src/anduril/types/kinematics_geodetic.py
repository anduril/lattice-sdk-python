...
class KinematicsGeodetic(UniversalBaseModel):
    location: typing.Optional[LocationGeodetic] = pydantic.Field(default=None)
    """
    The location of this entity.
    """

    location_uncertainty_enu: typing_extensions.Annotated[
        typing.Optional[TMat3],
        FieldMetadata(alias="locationUncertaintyEnu"),
        pydantic.Field(
            alias="locationUncertaintyEnu",
            description="Location uncertainty of this measurement, measured in the ENU frame. When there are multiple altitude\n measurements, this represents the most certain.",
        ),
    ] = None
    """
    ...
    velocity_enu_m_per_s: typing_extensions.Annotated[
        typing.Optional[Vec3],
        FieldMetadata(alias="velocityEnuMPerS"),
        pydantic.Field(
            alias="velocityEnuMPerS", description="Velocity in the ENU frame, measured in meters per second."
        ),
    ] = None
    """
    ...
    velocity_uncertainty_enu: typing_extensions.Annotated[
        typing.Optional[TMat3],
        FieldMetadata(alias="velocityUncertaintyEnu"),
        pydantic.Field(
            alias="velocityUncertaintyEnu",
