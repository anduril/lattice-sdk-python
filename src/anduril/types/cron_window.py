...
class CronWindow(UniversalBaseModel):
    ...
    duration_millis: typing_extensions.Annotated[
        ...
        pydantic.Field(alias="durationMillis", description="describes the duration"),
    ] = None
    """
