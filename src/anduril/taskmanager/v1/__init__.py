...
# sources: anduril/taskmanager/v1/task.pub.proto, anduril/taskmanager/v1/task_api.pub.proto, anduril/taskmanager/v1/task_manager_api.pub.proto
...
class CancelRequest(betterproto.Message):
    ...
    """
    The assignee of the Task. Useful for agent routing where an endpoint owns
    multiple agents, especially onBehalfOf assignees.
    """
...
class StreamTasksRequest(betterproto.Message):
    ...
    """
    Optional flag to only include tasks created or updated after the stream is
    initiated, and not any previous preexisting tasks. If unset, the stream
    will include any new tasks and task updates, as well as all preexisting
    tasks.
    """
...
class ListenAsAgentRequest(betterproto.Message):
    ...
    """
    The requesting agent will only receive Agent Tasks in the stream that have
    any of these specified entity ids as the task's assignee
    """
