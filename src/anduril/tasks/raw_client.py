...
class RawTasksClient:
    ...
    def listen_as_agent_stream(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> typing.Iterator[HttpResponse[typing.Iterator[ListenAsAgentStreamResponse]]]:
        """
        Establishes a server streaming connection that delivers tasks to taskable agents for execution
        ...
        with self._client_wrapper.httpx_client.stream(
            ...
            def _stream() -> HttpResponse[typing.Iterator[ListenAsAgentStreamResponse]]:
                try:
                    if 200 <= _response.status_code < 300:
                            ...
                            for _sse in _event_source.iter_sse():
                                ...
                                try:
                                    yield typing.cast(
                                        ...
                                        parse_obj_as(
                                            type_=ListenAsAgentStreamResponse,  # type: ignore
                                            object_=_sse.json(),
                                        ),
                                    )
...
class AsyncRawTasksClient:
    ...
    async def listen_as_agent_stream(
        ...
        *,
        ...
        heartbeat_interval_ms: typing.Optional[int] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> typing.AsyncIterator[AsyncHttpResponse[typing.AsyncIterator[ListenAsAgentStreamResponse]]]:
        """
        Establishes a server streaming connection that delivers tasks to taskable agents for execution
        using Server-Sent Events (SSE).
        ...
        async with self._client_wrapper.httpx_client.stream(
            ...
            async def _stream() -> AsyncHttpResponse[typing.AsyncIterator[ListenAsAgentStreamResponse]]:
                try:
                    if 200 <= _response.status_code < 300:
