...
<details><summary><code>client.objects.<a href="src/anduril/objects/client.py">list_deleted_objects</a>(...) -> ListDeletedObjectsResponse</code></summary>
<dl>
<dd>
...
client.objects.list_deleted_objects()
...
**page_token:** `typing.Optional[str]` — Opaque cursor returned by a prior response to continue paging.
...
**max_page_size:** `typing.Optional[int]` — Maximum number of records to return in a single response. Server enforces an upper bound.
